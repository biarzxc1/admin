...
def speak_with_sync_animation_bg(speech_text, display_text, bg_color=BG_G, delay=0.05):
    """Speak text and animate display text with background color"""
    speak(speech_text)
...
def main():
    ...
    speak_with_sync_animation_bg("Welcome to RPW Tools by Kendrick", "WELCOME TO RPWTOOLS BY KENDRICK", BG_G, 0.06)
    print()
    
    # Loading tools animation
    speak("Loading tools, please wait")
